...
if __name__ == '__main__':
    ...
    input1 = torch.rand(10, 3, 256, 256)
    input1 = input1.to('cuda')
    input2 = torch.rand(10, 3, 256, 256)
    input2 = input2.to('cuda')
    with SummaryWriter(comment='G') as w:
        w.add_graph(G, (input1))
    D = pix2pixD_256().to('cuda')
    with SummaryWriter(comment='D') as w:
        w.add_graph(D, (input1, input2))